...
def arguments():
    ...
    parser.add_argument('-i', dest='inp', nargs='?', type=argparse.FileType('r'),
                        default=sys.stdin, help="input data")
    parser.add_argument('-o', dest='out', nargs='?', type=argparse.FileType('w'),
                        default=sys.stdout, help="output data")
    parser.add_argument('--model', dest='model', nargs='?', type=str,
                        default="sseg_model.pkl", help="Name of model file (default: %(default)s).")
    parser.add_argument('--lang', dest='lang', nargs='?', type=str,
                        default="fr", help="Preprocessing language (default: %(default)s).")
